# Recuperación V2 con BGE-M3 y FAISS (PDF semántico)
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\recuperar_V2.py `
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\recuperar_V2.py `
    --output .\Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\resultado_v2.jsonl
```
