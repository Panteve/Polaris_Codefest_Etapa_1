# Recuperación V3 con Granite y FAISS (overlap 1)
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\recuperar_V3.py `
...
python .\Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\recuperar_V3.py `
  ...
  --output-json .\Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\resultado_v3_preguntas.json `
  --device cpu
```
