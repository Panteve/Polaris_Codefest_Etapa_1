"""Celda Kaggle completa para el corpus 05."""
...
INPUT=Path('/kaggle/input'); OUTPUT=Path('/kaggle/working'); HINT='05_granite_overlap_1'
RECALL_TOP_K=100; OUTPUT_TOP_K=10; BATCH_SIZE=8; MMR_LAMBDA=.7; DUP_THRESHOLD=.90
MODEL='ibm-granite/granite-embedding-311m-multilingual-r2'; RERANKER='BAAI/bge-reranker-v2-m3'; QUESTIONS='ground_truth_15_preguntas.json'
