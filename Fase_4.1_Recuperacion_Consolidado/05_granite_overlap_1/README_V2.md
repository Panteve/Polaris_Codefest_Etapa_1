# Recuperación V2 con Granite y FAISS (overlap 1)
...
1. Codificar y normalizar la consulta con `ibm-granite/granite-embedding-311m-multilingual-r2`.
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\recuperar_V2.py `
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\recuperar_V2.py `
    --output .\Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\resultado_v2.jsonl
```

Para recuperar 100 candidatos y mostrar 10:
