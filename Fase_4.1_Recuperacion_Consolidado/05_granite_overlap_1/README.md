# Recuperación con Granite overlap 1 y FAISS
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\recuperar_V1.py
```
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\recuperar_V1.py `
    --output .\Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\resultado.jsonl `
    --output-json .\Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\resultado.json
```
...
| `--index` | `Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\index.faiss` | Ruta del índice FAISS. |
| `--metadata` | `Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1\metadata.jsonl` | Ruta de la metadata JSONL. |
...
`Fase_4.1_Recuperacion_Consolidado\05_granite_overlap_1`: `index.faiss` y `metadata.jsonl`.
