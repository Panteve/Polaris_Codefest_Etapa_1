...
MODEL_NAME="ibm-granite/granite-embedding-311m-multilingual-r2"; RERANKER_NAME="BAAI/bge-reranker-v2-m3"; FOLDER=Path(__file__).resolve().parent; NEAR_DUPLICATE_THRESHOLD=0.90
