# Recuperación V3 con Granite y FAISS
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\03_granite_corpus\recuperar_V3.py `
...
python .\Fase_4.1_Recuperacion_Consolidado\03_granite_corpus\recuperar_V3.py `
  ...
  --output-json .\Fase_4.1_Recuperacion_Consolidado\03_granite_corpus\resultado_v3_preguntas.json `
  --device cpu
```
