# Recuperación V2 con Granite y FAISS
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\03_granite_corpus\recuperar_V2.py `
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\03_granite_corpus\recuperar_V2.py `
    --output .\Fase_4.1_Recuperacion_Consolidado\03_granite_corpus\resultado_v2.jsonl
```
