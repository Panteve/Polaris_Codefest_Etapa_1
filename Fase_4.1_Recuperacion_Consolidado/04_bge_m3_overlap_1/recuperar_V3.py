...
MODEL_NAME="BAAI/bge-m3"; RERANKER_NAME="BAAI/bge-reranker-v2-m3"; FOLDER=Path(__file__).resolve().parent; NEAR_DUPLICATE_THRESHOLD=0.90; DEFAULT_QUESTIONS_PATH=FOLDER.parent/"Validacion_20_Preguntas"/"ground_truth_15_preguntas.json"
