# Recuperación V2 con BGE-M3 y FAISS (overlap 1)
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\04_bge_m3_overlap_1\recuperar_V2.py `
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\04_bge_m3_overlap_1\recuperar_V2.py `
    --output .\Fase_4.1_Recuperacion_Consolidado\04_bge_m3_overlap_1\resultado_v2.jsonl
```
