# Recuperación V3 con BGE-M3 y FAISS (PDF semántico)
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\recuperar_V3.py `
...
python .\Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\recuperar_V3.py `
  ...
  --output-json .\Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\resultado_v3_preguntas.json `
  --device cpu
```
