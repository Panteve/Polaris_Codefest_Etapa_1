"""Recuperacion densa basica para el indice BGE-M3 de PDF semantico."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Recuperacion basica con BGE-M3 para PDF semantico.")
