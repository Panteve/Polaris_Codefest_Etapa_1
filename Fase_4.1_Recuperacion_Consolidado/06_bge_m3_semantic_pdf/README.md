# Recuperación con BGE-M3 semantic PDF y FAISS
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\recuperar_V1.py
```
...
```powershell
python .\Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\recuperar_V1.py `
    --output .\Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\resultado.jsonl `
    --output-json .\Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\resultado.json
```
...
| `--index` | `Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\index.faiss` | Ruta del índice FAISS. |
| `--metadata` | `Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf\metadata.jsonl` | Ruta de la metadata JSONL. |
...
`Fase_4.1_Recuperacion_Consolidado\06_bge_m3_semantic_pdf`: `index.faiss` y `metadata.jsonl`.
