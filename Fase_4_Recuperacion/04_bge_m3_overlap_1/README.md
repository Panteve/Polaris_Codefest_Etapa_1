# Recuperación — BGE-M3 overlap 1

Ejecuta la recuperación sobre `Fase_3_Encoder\04_bge_m3_overlap_1`.

```powershell
python .\Fase_4_Recuperacion\04_bge_m3_overlap_1\recuperar.py --query "..."
```
