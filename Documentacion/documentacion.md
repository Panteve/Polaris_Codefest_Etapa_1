...
Especificación Técnica Etapa 1 • Construcción de la Base de Conocimiento
...
Introducción
1.1. Contexto del reto . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 1.2. Objetivo de la Etapa 1 . . . . . . . . . . . . . . . . . . . . . . . . . . Insumos provistos por ADL . . . . . . . . . . . . . . . . . . . . . . . 1.3. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 1.4. Entregables

Preprocesamiento de las Fuentes
2.1. Extracción de texto . . . . . . . . . . . . . . . . . . . . . . . . . . . . 2.2. Limpieza y normalización . . . . . . . . . . . . . . . . . . . . . . . . Identificación de documentos . . . . . . . . . . . . . . . . . . . . . . . 2.3.

Chunking: Fragmentación del Texto
3.1. ¿Qué es el chunking? . . . . . . . . . . . . . . . . . . . . . . . . . . . 3.2. Estrategias de chunking . . . . . . . . . . . . . . . . . . . . . . . . . 3.3. Requisito de completitud lingüística . . . . . . . . . . . . . . . . . . . 3.4. Metadata obligatoria por fragmento . . . . . . . . . . . . . . . . . . .
...
Codificación Semántica: Encoders y Embeddings
9 4.1. ¿Qué son los embeddings? . . . . . . . . . . . . . . . . . . . . . . . . 10 . . . . . . . . . . . . . . . . . . . . . . . . . . 10 4.2. Encoders vs. decoders . . . . . . . . . . . . . . . . . . . . 10 4.3. Criterios de selección del encoder . . . . . . . . . . . . . . . . . . . . . . . . 11 4.4. Uso de múltiples encoders

Gestión del Índice Vectorial con FAISS
11 5.1. ¿Qué es FAISS? . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 11 5.2. Tipos de índice . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 5.3. Relación entre el índice FAISS y el almacén de metadata . . . . . . . 12 . . . . . . . . . . . . . . . . . . . . . . . . . . 12 5.4. Persistencia del índice

Flujo Completo de Indexación
13 6.1. Descripción paso a paso . . . . . . . . . . . . . . . . . . . . . . . . . 13

Grafo de Conocimiento (Componente Bonus)
14 7.1. ¿Qué es un grafo de conocimiento? . . . . . . . . . . . . . . . . . . . 14 7.2. Construcción del grafo . . . . . . . . . . . . . . . . . . . . . . . . . . 14 7.3. Vinculación con la base vectorial . . . . . . . . . . . . . . . . . . . . . 15

Módulo de Recuperación
15 8.1. Flujo general de recuperación . . . . . . . . . . . . . . . . . . . . . . 15 8.2. Similitud coseno . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 15 8.3. Restricción sobre modelos generativos . . . . . . . . . . . . . . . . . . 16 8.4. Combinación de múltiples bases vectoriales . . . . . . . . . . . . . . . 16 Integración con el grafo de conocimiento . . . . . . . . . . . . . . . . 17 8.5. 8.6. Agregación de fragmentos al nivel de documento . . . . . . . . . . . . 17 8.7. Post-filtros basados en vectores o metadata . . . . . . . . . . . . . . . 18
...
Formato de Salida
18 9.1. Diferencia entre fragmento y documento . . . . . . . . . . . . . . . . 18 9.2. Estructura de la respuesta por consulta . . . . . . . . . . . . . . . . . 18 9.2.1. Reglas para cumplir el límite de 250 palabras por fragmento . 18 . . . . . . . . . . . . 19 9.3.1. Esquema de cada objeto JSON . . . . . . . . . . . . . . . . . 19 9.3.2. Campos del esquema . . . . . . . . . . . . . . . . . . . . . . . 20

9.3. Formato del archivo de resultados: JSON Lines

10.Evaluación

20 10.1. Dataset de evaluación . . . . . . . . . . . . . . . . . . . . . . . . . . . 20 10.2. Métricas de evaluación . . . . . . . . . . . . . . . . . . . . . . . . . . 20 10.2.1. NDCG@10 para fragmentos . . . . . . . . . . . . . . . . . . . 21 10.2.2. F1@3 para documentos . . . . . . . . . . . . . . . . . . . . . . 21 10.3. Instrucciones de entrega . . . . . . . . . . . . . . . . . . . . . . . . . 22

11.Clasificación de Equipos

22 11.1. Tablas clasificatorias por métrica . . . . . . . . . . . . . . . . . . . . 22 11.2. Leaderboard unificado mediante Conteo de Borda . . . . . . . . . . . 22 11.2.1. Procedimiento . . . . . . . . . . . . . . . . . . . . . . . . . . . 23 11.2.2. Ejemplo . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 23
...
Base vectorial (obligatorio): el índice FAISS y el almacén de metadata correspondiente, organizados en subcarpetas por encoder. Si se implementó más de un encoder, cada uno tiene su propia subcarpeta. El formato estándar requerido es:
...
Si el equipo construyó el grafo de conocimiento opcional (Sección 7), debe incluirse en una subcarpeta grafo/ como un archivo grafo.graphml, forma- to GraphML, exportable directamente desde NetworkX, Neo4j o cualquier herramienta compatible.

Archivo de resultados en formato JSON Lines (véase la Sección 9), deno- minado resultados.jsonl, con exactamente 50 líneas correspondientes a las consultas q001–q050.
Documento técnico en PDF (máximo 8 páginas) que describa las decisiones de diseño tomadas: estrategia de chunking y su justificación, encoder(s) selec- cionado(s) y criterios de elección, tipo de índice FAISS empleado, y, de aplicar, la descripción del grafo de conocimiento.
Script Python que utilice el índice, lea el archivo de consultas y genere el archivo de resultados resultados.jsonl. Nombre generador.py. El objetivo es reproducir los resultados. Si no es posible reproducir los resultados, se excluirá de la evaluación.
5
...
resultados.jsonl generador.py informe_tecnico.pdf base_vectorial/
...
Tabla 1: Campos de metadata obligatorios por fragmento. Tipo Descripción

Identificador único del documento de origen. Identificador único del fragmento dentro del documento.

cadena cadena cadena Nombre o URL del archivo original provisto por ADL. cadena Formato del archivo de origen: pdf, html o md. entero entero

Fenómeno temático al que pertenece el documento (1, 2 o 3). Índice ordinal del fragmento dentro del documento (empieza en 0).

num_tokens texto

entero Número de tokens del fragmento. cadena Texto original del fragmento, sin modificaciones.
...
IndexIVFFlat Índice basado en cuantificación vectorial invertida (Inverted File Index). El espacio vectorial se divide en k celdas mediante k-medias. En la búsqueda, solo se exploran las nprobe celdas más cercanas a la consulta, lo que reduce el costo computacional a cambio de una pequeña pérdida en exactitud.
...
Para el volumen de documentos esperado en este reto, un índice plano (IndexFlatIP

con vectores normalizados, equivalente a similitud coseno) es suficiente y garantiza resultados exactos. Los índices aproximados son apropiados si el equipo trabaja con corpus de gran escala o si el tiempo de respuesta es un factor crítico.
...
Índice FAISS: recibe un vector de consulta y devuelve los k identificadores
internos más similares junto con sus puntuaciones.

Almacén de metadata: dado un identificador interno, devuelve el texto del
...
Documentos ADL: los archivos en PDF, HTML y Markdown constituyen la entrada del sistema. Cada archivo es un documento con un doc_id asignado.
Extracción y limpieza: se extrae el texto plano de cada documento y se aplica la normalización descrita en la Sección 2. El resultado es un texto limpio listo para ser fragmentado.
Chunking: el texto limpio se divide en fragmentos según la estrategia definida por el equipo (Sección 3). A cada fragmento se le asigna su chunk_id y se construye su registro de metadata.
Encoder: cada fragmento se pasa al modelo encoder. El encoder produce un vector v ∈ Rd que representa semánticamente el contenido del fragmento. Si se emplean múltiples encoders, este paso se repite para cada uno, generando un conjunto de vectores por fragmento.
Vectores: el conjunto de vectores de todos los fragmentos del corpus está listo para ser indexado. Si los vectores serán comparados mediante similitud coseno, deben normalizarse a norma unitaria antes de insertarlos en el índice.
Índice FAISS: los vectores normalizados se insertan en el índice FAISS. El índice asigna un identificador interno entero a cada vector. Este identificador debe vincularse al chunk_id correspondiente en el almacén de metadata.
Almacén de metadata: en paralelo, el registro de metadata de cada fragmento se persiste en el almacén externo. La clave de acceso es el identificador interno FAISS o el chunk_id.
13
...
donde E es el conjunto de entidades, R el conjunto de tipos de relaciones, y T el conjunto de tripletas (esujeto, r, eobjeto) que describen hechos del dominio.
...
Reconocimiento de entidades (NER): se identifican y clasifican las enti- dades mencionadas en el texto (personas, organizaciones, países, tecnologías, eventos, etc.) mediante modelos de reconocimiento de entidades nombradas. Se recomiendan modelos open source disponibles en HuggingFace entrenados para NER multilingüe.
Extracción de relaciones (RE): se identifican las relaciones semánticas entre pares de entidades dentro del mismo fragmento o párrafo. Esto puede realizarse mediante modelos de clasificación de relaciones, heurísticas basadas en patrones lingüísticos, o dependencias sintácticas.
Construcción e integración del grafo: las tripletas extraídas se almacenan en una estructura de grafo. Cada tripleta mantiene una referencia al doc_id y al chunk_id de origen, lo que permite rastrear la evidencia textual de cada relación. Herramientas como NetworkX (Python, en memoria), Neo4j (base de datos de grafos) o RDFLib (grafos RDF) pueden emplearse para este fin.
14
...
Top-k fragmentos y documentos

Figura 2: Flujo de recuperación: de la consulta al resultado.

La consulta del usuario se pasa al mismo encoder utilizado durante la indexación. Es imprescindible utilizar el mismo encoder para garantizar que los vectores de consulta y los vectores del índice habiten el mismo espacio semántico.
El encoder produce el vector de consulta q ∈ Rd. Si los vectores del índice
están normalizados, q debe normalizarse también.

FAISS compara q contra todos los vectores del índice y devuelve los k fragmentos
más similares con sus puntuaciones.

Para cada identificador devuelto por FAISS se recupera la metadata correspon- diente del almacén externo, incluyendo el texto del fragmento y el doc_id de origen.
A partir de los chunks recuperados se construyen los dos niveles de resultado
...
donde q · v = Pd euclidiana del vector u.

i=1 qivi es el producto punto, y ∥u∥ =
...
cos(q, v) = q · v (para vectores normalizados)
...
CombMNZ Similar a CombSUM, pero multiplica la suma por el número de índi- ces en los que el fragmento aparece, favoreciendo la consistencia entre encoders:
...
los rangos rj(c) de cada fragmento en cada índice:
...
donde k0 es una constante de suavizado (típicamente k0 = 60) y rj(c) es la posición del fragmento c en la lista ordenada del índice j (empieza en 1). RRF es robusto a la diferencia de escalas entre puntuaciones de distintos encoders.
...
Se identifican las entidades mencionadas en la consulta mediante el mismo
componente NER utilizado durante la construcción del grafo.

Se consulta el grafo para recuperar los chunks vinculados a dichas entidades y a las entidades directamente relacionadas con ellas (vecinos de primer orden en el grafo).
Los chunks recuperados por el grafo se incorporan al pool de candidatos y se les asigna una puntuación basada en el número de relaciones relevantes encontradas.
Este pool de candidatos del grafo se fusiona con los resultados vectoriales de FAISS mediante una de las estrategias de combinación descritas en la Sección 8.4 (e.g., RRF tratando el grafo como un índice adicional).
...
Los kchunk fragmentos más relevantes (con sus puntuaciones) se agrupan por
doc_id.

Para cada documento, se calcula una puntuación agregada. Las estrategias habituales son: puntuación del fragmento más relevante del documento (max pooling), suma de las puntuaciones de todos sus fragmentos recuperados, o media ponderada.
Los documentos se ordenan de mayor a menor puntuación agregada y se
...
Un fragmento (chunk) es la unidad mínima de texto que se almacena en la base vectorial, identificado por su chunk_id. Corresponde a una porción del documento original delimitada por la estrategia de chunking del equipo. Un documento es el archivo original provisto por ADL, identificado por su doc_id. Un documento contiene uno o más fragmentos. La relevancia de un documento se infiere a partir de la relevancia de sus fragmentos (véase Sección 8.6).
...
Los 3 documentos más relevantes: lista ordenada de 3 doc_id, de mayor a
menor relevancia agregada.

Los 10 fragmentos más relevantes: lista ordenada de 10 objetos, cada uno con el texto del fragmento y su chunk_id. Cada fragmento debe tener como máximo 250 palabras.
...
" query_id ": " q 0 0 1 " , " documents ": [

{" rank ": 1 , " doc_id ": " DOC - 0 4 2 "} , {" rank ": 2 , " doc_id ": " DOC - 0 1 7 "} , {" rank ": 3 , " doc_id ": " DOC - 0 9 1 "}

] , " fragments ": [

" rank ": 1 , " chunk_id ": " DOC - 0 4 2 - chunk - 0 0 7 " , " doc_id ": " text ": ..."

" DOC - 0 4 2 " , " Texto del fragmento de hasta 2 5 0 palabras

" rank ": 2 , " chunk_id ": " DOC - 0 1 7 - chunk - 0 0 3 " , " doc_id ": " text ": ..."

" DOC - 0 1 7 " , " Texto del fragmento de hasta 2 5 0 palabras
...
documents[i].rank documents[i].doc_id fragments

fragments[i].rank fragments[i].chunk_id fragments[i].doc_id

cadena array

Identificador de la consulta (q001–q050). Lista de exactamente 3 objetos de documento, ordenados de mayor a menor relevancia.

entero Posición en el ranking (1, 2, 3). cadena array

Identificador del documento. Lista de exactamente 10 objetos de fragmento, ordenados de mayor a menor relevancia.

entero Posición en el ranking (1 a 10). cadena cadena

Identificador del chunk recuperado del índice. Identificador del documento de origen del frag- mento.

fragments[i].text

cadena Texto del fragmento (≤ 250 palabras).
...
Cada consulta tiene asociada una lista de relevancia (ground truth) cons- truida manualmente por el equipo de CODEFEST, que indica qué documentos y qué fragmentos son relevantes para esa consulta y en qué grado. Esta lista no es pública durante el reto; su comparación con los resultados entregados por los equipos determina las métricas de evaluación.
...
Dado el vector de relevancia r = (r1, r2, . . . , r10), donde ri ≥ 0 es la relevancia
...
donde ˆDq es el conjunto de 3 doc_id devueltos por el equipo para la consulta q, q es el conjunto de documentos relevantes según el ground truth. El denominador q |, 3) para no penalizar casos en los que el número de

y D∗ de R@3 se limita a m´ın(|D∗ documentos relevantes es inferior a 3.
...
Los equipos deben entregar un único archivo resultados.jsonl con exacta- mente 50 líneas, una por consulta, en el orden q001, q002, . . . , q050. El archivo debe cumplir el esquema especificado en la Sección 9. Entregas fuera de plazo o con formato incorrecto no serán consideradas en la evaluación.
...
i Tabla B, respectivamente.

y B F1 i

son los puntos de Borda del equipo i en la Tabla A y la
...
Construir la Tabla A ordenando los equipos por NDCG@10. Asignar puntos de i es la posición del equipo i en la Tabla A.
Borda: B NDCG
...
Construir la Tabla B ordenando los equipos por F1@3. Asignar puntos de
Borda: B F1
...
Ordenar los equipos de mayor a menor Bi. El resultado es el Leaderboard
Unificado.
...
Tabla 3: Ejemplo de Conteo de Borda con 4 equipos hipotéticos. Equipo NDCG@10 Pos. A BNDCG F1@3 Pos. B BF1 B total
